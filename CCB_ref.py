...
def _TG_func3(x,frame):
    ...
    OR=Rot_mat@OR_start
    #kout_dir_dict=CCB_read.kout_read('/home/lichufen/CCB_ind/k_out.txt')#changed for batch mode, running on server.
    kout_dir_dict=CCB_read.kout_read('../k_out.txt')# for local computer
