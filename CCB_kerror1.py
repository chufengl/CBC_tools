...
def get_kerror_frame(exp_img_file,frame,res_file='/home/lichufen/CCB_ind/Best_GA_res.txt',thld=10,min_pix=20):
	...
	K_pix_arry_all, HKL_int, Pxy_cen_arry, OR, props=CCB_kmap1.get_K_frame(exp_img_file,frame,res_file='/home/lichufen/CCB_ind/Best_GA_res.txt',thld=thld,min_pix=min_pix)
