...
def get_K_frame(exp_img_file,frame,res_file='/home/lichufen/CCB_ind/Best_GA_res.txt',thld=10,min_pix=10):
	...
	'''
	label_filtered_sorted,weighted_centroid_filtered,props,exp_img=CCB_streak_det.single_peak_finder(exp_img_file,frame,thld=10,min_pix=10,mask_file='/home/lichufen/CCB_ind/mask.h5',interact=False)
	...
	for ind, s_ind in np.ndenumerate(streak_ind):
		...
		x_pix=(K_pix_arry[:,1]-1540)*75e-6
		y_pix=(K_pix_arry[:,2]-1730)*75e-6
		z_pix=np.ones((num_pix,))*0.1025*cam_len
...
if __name__=='__main__':
	...
	for frame in range(start_frame,end_frame+1):
		K_pix_arry_all=get_K_frame(exp_img_file,frame,res_file='/home/lichufen/CCB_ind/Best_GA_res.txt',thld=10,min_pix=10,)
